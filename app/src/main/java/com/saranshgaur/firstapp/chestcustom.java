...
/**
 * Created by saransh gaur on 07-07-2016.
 */
public class chestcustom extends ArrayAdapter<User> {
    private final ArrayList<User> excercise1;
    private final Context context;
    private int[] imgs1;
    public chestcustom(Context context, ArrayList<User> excercise1, int[] imgs) {

        super(context, R.layout.chestcustom_row, excercise1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View coustomView = inflater.inflate(R.layout.chestcustom_row, parent, false);
