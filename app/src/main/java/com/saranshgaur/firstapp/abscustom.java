 ...
 */
public class abscustom extends ArrayAdapter<User> {
    private final ArrayList<User> excercise1;
    private final Context context;
    private int[] imgs1;
    public abscustom(Context context, ArrayList<User> excercise1, int[] imgs) {

        super(context, R.layout.abscustom_row, excercise1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View coustomView = inflater.inflate(R.layout.abscustom_row, parent, false);
