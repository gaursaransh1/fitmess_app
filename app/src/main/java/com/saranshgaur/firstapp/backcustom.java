...
public class backcustom extends ArrayAdapter<User> {
    private final ArrayList<User> excercise1;
    private final Context context;
    private int[] imgs1;
    public backcustom(Context context, ArrayList<User> excercise1, int[] imgs) {

        super(context, R.layout.backcustom_row, excercise1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View coustomView = inflater.inflate(R.layout.backcustom_row, parent, false);
