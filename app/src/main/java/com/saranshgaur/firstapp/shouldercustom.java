...
/**
 * Created by saransh gaur on 11-07-2016.
 */
public class shouldercustom extends ArrayAdapter<User> {
    private final ArrayList<User> excercise1;
    private final Context context;
    private int[] imgs1;
    public shouldercustom(Context context, ArrayList<User> excercise1, int[] imgs) {

        super(context, R.layout.shouldercustom_row, excercise1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View coustomView = inflater.inflate(R.layout.shouldercustom_row, parent, false);
